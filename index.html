...
<html lang="en">
  ...
  <body>
        ...
        <div class="bg-color">
                ...
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#mynavbar" aria-expanded="false" aria-controls="navbar">
                            ...
                            <a href="index.html" class="navbar-brand">Profil</a>
                        </div>
            ...
            <div class="container text-center">
                <div class="wrapper wow fadeInUp delay-05s" >
                    <h2 class="top-title">Freelance</h2>
                    <h3 class="title">AppMyAdmin</h3>
                    <h4 class="sub-title">We Create amazing designs</h4>
                    <a href="#"><button type="submit" class="btn btn-submit">CV</button></a>
                    <a href="#"><button type="submit" class="btn btn-submit">Portofolio</button></a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="cta-info text-center">
                    <h3><span class="dec-tec">“</span>Judge a man by this questions rather than by his answers.<span class="dec-tec">”</span> -Voltaire</h3>
                </div>
            </div>
        </div>
    </section>
    <!---->
    <!----> 
    <section id="pendidikan" class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-3 wow fadeInLeft delay-05s">
                    <div class="section-title">
                        <h2 class="head-title">Pendidikan</h2>
                        <hr class="botm-line">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <a href="https://bit.ly/3fc1zZe" class="btn btn-submit">Subscribe Now</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!---->
    <section class="section-padding wow fadeInUp delay-02s" id="pk">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="section-title">
                        <h2 class="head-title">Pengalaman Kerja</h2>
                        <hr class="botm-line">
                        <p class="sec-para"></p>
                    </div>
                </div>
            ...
            <div class="row white">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-4 col-sm-6" style="padding-left:0px;">
                        ...
                        <button onclick="window.location='https://www.samuelpasaribu.com/p/contact.html' " style="background-color: #FFD34E; color: rgb(34, 28, 28); height: 35px; width: 120px;"><b>Kirim</b></button>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="location-info">
                            <p class="white"><span aria-hidden="true" class="fa fa-map-marker"></span>Jl. Keluarga No.122, Tj. Mulia Hilir, Kec. Medan Deli, Kota Medan, Sumatera Utara</p>
                            <p class="white"><span aria-hidden="true" class="fa fa-phone"></span>Phone: +62 859-6030-6011</p>
                            <p class="white"><span aria-hidden="true" class="fa fa-envelope"></span>Email: <a href="" class="link-dec">codinglan420@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-7 footer-copyright">
                    © 2021 AppMyAdmin Theme - All rights reserved
                    <div class="credits">
                        <!-- 
                        ...
                        -->
                        Designed by <a href="https://www.samuelpasaribu.com/">Samuel Pasaribu</a>| Blogger UI, UX By <a href="https://phpmyadmin.blogspot.com/">AppMyAdmin</a>
                    </div>
                </div>
